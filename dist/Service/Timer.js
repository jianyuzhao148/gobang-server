...
var RoomHandle_1 = require("./RoomHandle");
var Timer = /** @class */ (function () {
    function Timer(cacheDataBase, socket, io) {
    ...
    Timer.prototype.setTimer = function (key) {
        var _this = this;
        this.outTimer(function (message) { return __awaiter(_this, void 0, void 0, function () {
            var roomHandle, room;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        roomHandle = new RoomHandle_1.RoomHandle(this.socket, this.io);
                        return [4 /*yield*/, roomHandle.getRoom(message)];
                    case 1:
                        room = _a.sent();
        ...
        this.cache.setLimitKey(key, "", Global_1.Global.getConfig().get("game.Timer"));
    };
    /**
     * 超时处理
     * @param func 回调超时的Key
